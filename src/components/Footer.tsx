...
// Simple component for footer links
    ...
    <footer className="bg-black/90 border-t border-gray-800 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold text-gradient mb-4">SOD 2025</h3>
            <p className="text-gray-400 mb-4">
              A day of relaxation and networking exclusively for MSc Business Analytics students at the University of Ghana Business School.
            </p>
